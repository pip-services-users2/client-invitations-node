...
exports.InvitationsLambdaClientV1 = void 0;
const pip_services3_commons_nodex_1 = require("pip-services3-commons-nodex");
const pip_services3_aws_nodex_1 = require("pip-services3-aws-nodex");
class InvitationsLambdaClientV1 extends pip_services3_aws_nodex_1.CommandableLambdaClient {
    constructor(config) {
        super('invitations');
        if (config != null)
    ...
    approveInvitation(correlationId, invitationId, role) {
        return __awaiter(this, void 0, void 0, function* () {
            let timing = this.instrument(correlationId, 'invitations.approved_invitation');
            try {
...
exports.InvitationsLambdaClientV1 = InvitationsLambdaClientV1;
//# sourceMappingURL=InvitationsLambdaClientV1.js.map